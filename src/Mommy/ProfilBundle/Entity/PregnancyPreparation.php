...
/**
 * Mommy\ProfilBundle\Entity\PregnancyPreparation
 *
 * @ORM\Table(name="mv_pregnancy_preparation", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
 */
class PregnancyPreparation
{
    /**
