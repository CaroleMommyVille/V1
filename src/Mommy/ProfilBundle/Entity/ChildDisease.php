...
/**
 * Mommy\ProfilBundle\Entity\ChildDisease
 *
 * @ORM\Table(name="mv_child_disease", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
...
class ChildDisease
{
    ...
    public function setHasDetail($detail) {
        if (!is_string($detail)) $this->has_detail = '';
