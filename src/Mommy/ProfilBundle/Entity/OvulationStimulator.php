...
/**
 * Mommy\ProfilBundle\Entity\OvulationStimulator
 *
 * @ORM\Table(name="mv_ovulation_stimulator", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
 */
class OvulationStimulator
{
    /**
