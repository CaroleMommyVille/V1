...
/**
 * Mommy\ProfilBundle\Entity\Quarter1
 *
 * @ORM\Table(name="mv_quarter1", indexes={@ORM\Index(name="search_idx", columns={"id", "pid"})})
 * @ORM\Entity()
 */
class Quarter1
{
    ...
    public function getConsult1() {
        return $this->consult1;
    }

    public function setConsult1($bool) {
        $this->consult1 = ($bool === true);
    }
