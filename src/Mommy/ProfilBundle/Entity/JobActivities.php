...
/**
 * Mommy\ProfilBundle\Entity\JobActivities
 *
 * @ORM\Table(name="mv_job_activities", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
...
class JobActivities
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="JobActivitiesCategories")
