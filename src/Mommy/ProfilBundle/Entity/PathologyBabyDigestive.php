...
/**
 * Mommy\ProfilBundle\Entity\PathologyBabyDigestive
 *
 * @ORM\Table(name="mv_pathology_baby_digestive", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
 */
class PathologyBabyDigestive
{
    /**
