...
/**
 * Mommy\ProfilBundle\Entity\JobActivitiesCategories
 *
 * @ORM\Table(name="mv_job_activities_categories", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
 */
class JobActivitiesCategories
{
    /**
