...
/**
 * Mommy\ProfilBundle\Entity\AdoptApprovalEase
 *
 * @ORM\Table(name="mv_adopt_approval_ease", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
  */
class AdoptApprovalEase
{
    /**
