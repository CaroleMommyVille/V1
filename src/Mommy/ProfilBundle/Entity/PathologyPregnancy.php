...
/**
 * Mommy\ProfilBundle\Entity\PathologyPregnancy
 *
 * @ORM\Table(name="mv_pathology_pregnancy", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
 */
class PathologyPregnancy
{
    /**
