...
/**
 * Mommy\ProfilBundle\Entity\DeliveryMethodChange
 *
 * @ORM\Table(name="mv_delivery_method_change", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
 */
class DeliveryMethodChange
{
    /**
