...
/**
 * Mommy\ProfilBundle\Entity\Quarter2
 *
 * @ORM\Table(name="mv_quarter2", indexes={@ORM\Index(name="search_idx", columns={"id", "pid"})})
 * @ORM\Entity()
 */
class Quarter2
{
    ...
    public function getConsult2() {
        return $this->consult2;
    }

    public function setConsult2($bool) {
        $this->consult2 = ($bool === true);
    }
    ...
    public function getJobInformed() {
        return $this->job_informed;
    }

    public function setJobInformed($bool) {
        $this->job_informed = ($bool == true);
    }
}