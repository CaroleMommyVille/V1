...
/**
 * Mommy\ProfilBundle\Entity\PathologyBabyEye
 *
 * @ORM\Table(name="mv_pathology_baby_eye", indexes={@ORM\Index(name="search_idx", columns={"id", "name"})})
 * @ORM\Entity()
 * @DoctrineAssert\UniqueEntity(fields={"name"}, message="name.already.exist" )
 */
class PathologyBabyEye
{
    /**
