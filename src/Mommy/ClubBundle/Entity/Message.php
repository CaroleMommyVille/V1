...
/**
 * Mommy\ClubBundle\Entity\Message
 *
 * @ORM\Table(name="mv_club_message", indexes={@ORM\Index(name="search_idx", columns={"id", "aid", "wid", "date"})})
 * @ORM\Entity()
  */
class Message
{
    ...
    public function setWall(Club $club) {
        $this->wall = $club;
    }
