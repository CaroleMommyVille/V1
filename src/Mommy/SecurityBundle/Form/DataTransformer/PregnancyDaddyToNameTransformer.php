...
class PregnancyDaddyToNameTransformer implements DataTransformerInterface
{
    /**
     * @var ObjectManager
     */
    ...
    /**
     * @param  PregnancyDaddy|null $type
     * @return string
     */
    ...
    public function reverseTransform($name)
    {
        ...
        $type = $this->om->getRepository('MommyProfilBundle:PregnancyDaddy')->findOneBy(array('name' => $name));
